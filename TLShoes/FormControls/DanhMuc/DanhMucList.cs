...
namespace TLShoes
{
    public partial class ucDanhMucList : BaseForm
    {
        public ucDanhMucList()
        {
            ...
            this.danhMucInstantFeedbackSource.GetQueryable += entityInstantFeedbackSource1_GetQueryable;
            // This line of code is generated by Data Source Configuration Wizard
            this.danhMucInstantFeedbackSource.DismissQueryable += entityInstantFeedbackSource1_DismissQueryable;
        }

        public override void ReloadData()
        {
            gridControl.DataSource = null;
            gridControl.DataSource = danhMucInstantFeedbackSource;
        }
        ...
        private void gridView_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                var info = SF.Get<DanhMucViewModel>().GetDetail(GetFocusRowId(sender));
                if (info != null)
                {
        ...
        void entityInstantFeedbackSource1_GetQueryable(object sender, DevExpress.Data.Linq.GetQueryableEventArgs e)
        {
            ...
            e.QueryableSource = dataContext.DanhMucs;
