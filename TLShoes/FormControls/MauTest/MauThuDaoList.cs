...
namespace TLShoes.FormControls.MauThuDao
{
    public partial class ucMauThuDaoList : BaseForm
    {
        public ucMauThuDaoList()
        {
            ...
            this.mauThuDaoInstantFeedbackSource.GetQueryable += entityInstantFeedbackSource1_GetQueryable;
            // This line of code is generated by Data Source Configuration Wizard
            this.mauThuDaoInstantFeedbackSource.DismissQueryable += entityInstantFeedbackSource1_DismissQueryable;
        }

        public override void ReloadData()
        {
            gridControl.DataSource = null;
            gridControl.DataSource = mauThuDaoInstantFeedbackSource;
        }
        ...
        private void gridView_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                var info = SF.Get<MauThuDaoViewModel>().GetDetail(GetFocusRowId(sender));
                if (info != null)
                {
        ...
        void entityInstantFeedbackSource1_GetQueryable(object sender, DevExpress.Data.Linq.GetQueryableEventArgs e)
        {
            ...
            e.QueryableSource = dataContext.MauThuDaos;
