...
namespace TLShoes.FormControls.DonHang
{
    public partial class ucMauDoiList : BaseForm
    {
        public ucMauDoiList()
        {
            ...
            this.mauDoiInstantFeedbackSource.GetQueryable += entityInstantFeedbackSource1_GetQueryable;
            // This line of code is generated by Data Source Configuration Wizard
            this.mauDoiInstantFeedbackSource.DismissQueryable += entityInstantFeedbackSource1_DismissQueryable;
        }

        public override void ReloadData()
        {
            gridControl.DataSource = null;
            gridControl.DataSource = mauDoiInstantFeedbackSource;
        }
        ...
        private void gridView_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                var info = SF.Get<MauDoiViewModel>().GetDetail(GetFocusRowId(sender));
                if (info != null)
                {
        ...
        void entityInstantFeedbackSource1_GetQueryable(object sender, DevExpress.Data.Linq.GetQueryableEventArgs e)
        {
            ...
            e.QueryableSource = dataContext.MauDois;
