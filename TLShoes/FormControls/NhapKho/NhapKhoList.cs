...
namespace TLShoes.FormControls.NhapKho
{
    public partial class ucNhapKhoList : BaseForm
    {
        public ucNhapKhoList()
        {
            ...
            this.pnkInstantFeedbackSource.GetQueryable += entityInstantFeedbackSource1_GetQueryable;
            // This line of code is generated by Data Source Configuration Wizard
            this.pnkInstantFeedbackSource.DismissQueryable += entityInstantFeedbackSource1_DismissQueryable;
        }

        public override void ReloadData()
        {
            gridControl.DataSource = null;
            gridControl.DataSource = pnkInstantFeedbackSource;
        }
        ...
        private void gridView_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                var info = SF.Get<PhieuNhapKhoViewModel>().GetDetail(GetFocusRowId(sender));
                if (info != null)
                {
        ...
        void entityInstantFeedbackSource1_GetQueryable(object sender, DevExpress.Data.Linq.GetQueryableEventArgs e)
        {
            ...
            e.QueryableSource = dataContext.PhieuNhapKhoes;
