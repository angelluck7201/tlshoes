...
namespace TLShoes.FormControls.ChiLenh
{
    public partial class ucChiLenhList : BaseForm
    {
        public ucChiLenhList()
        {
            ...
            this.chiLenhInstantFeedbackSource.GetQueryable += entityInstantFeedbackSource1_GetQueryable;
            // This line of code is generated by Data Source Configuration Wizard
            this.chiLenhInstantFeedbackSource.DismissQueryable += entityInstantFeedbackSource1_DismissQueryable;
        }

        public override void ReloadData()
        {
            gridControl.DataSource = null;
            gridControl.DataSource = chiLenhInstantFeedbackSource;
        }
        ...
        private void gridView_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                var info = SF.Get<ChiLenhViewModel>().GetDetail(GetFocusRowId(sender));
                if (info != null)
                {
        ...
        void entityInstantFeedbackSource1_GetQueryable(object sender, DevExpress.Data.Linq.GetQueryableEventArgs e)
        {
            ...
            e.QueryableSource = dataContext.ChiLenhs;
